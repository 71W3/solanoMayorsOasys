...
// Google OAuth Simulator - Works like real Google OAuth without setup
...
<head>
    ...
    <title>Google OAuth Simulator - Solano Mayor's Office</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
    ...
    <div class="google-container">
        <div class="google-header">
            <h1><i class="bi bi-google me-3"></i>Google OAuth Simulator</h1>
